                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="last_name" name="last_name" value="${client.nom}" onblur="validateForm()" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="first_name" name="first_name" value="${client.prenom}" onblur="validateForm()" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="email" name="email" value="${client.email}" onblur="validateForm()" required>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="box-footer">
                                <button id="addButton" type="submit" class="btn btn-info pull-right" disabled>Modifier</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
...
<script>
    ...
    function validateForm() {
        ...
        if (formValableAge && formValableNom && formValablePrenom && formValable3) {
            formValable = true;
        }
